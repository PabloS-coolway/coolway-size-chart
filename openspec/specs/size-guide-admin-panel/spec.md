...
bloques de contenido se muestran siempre con su formulario completo
visible (sin necesidad de pulsar "Editar" para expandirlos).
...
- **WHEN** el usuario modifica los campos del formulario de un bloque
  de la lista y pulsa "Guardar bloque"
- **THEN** se guarda solo ese bloque, sin cambiar de URL ni afectar a
  los demás bloques, la guía o la regla
